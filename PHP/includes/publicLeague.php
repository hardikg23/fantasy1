 ...
 */
                    $leagueMember='s'.$seriesId.'_public_league_member';
                                                        ...
                                                        where user_email='$session_email'"))
                    {
                        ...
                        echo '<table class="private-league-table public-league-th">';
                        echo '<tr>';
                        ...
                        while($row=mysql_fetch_array($resultSet_league_data)) {
                            ...
                            echo '<tr>';
                            echo "<td class='private-league-table-a'><a href=League.php?seriesId=$seriesId&plid=$LeagueID>$LeagueName</a></td><td>$member</td><td>$rank</td>";
                            echo '</tr>';
                        }
                        echo '</table>';
                    }else {
