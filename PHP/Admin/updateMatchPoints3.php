...
function updatePlyerPoints($id,$style,$matchType,$runs,$duck,$balls,$sixs,$overs,$minOvers,
    ...
    $batPoints=0;$ballPoints=0;$fieldPoints=0;$bonusPoints=0;
...
//echo "batPointsWik$ballPoints<br>";
    ...
    }else if(strtoupper($matchType) == 'T20')
    {
        ...
        $totalPoints=$batPoints+$ballPoints+$fieldPoints+$bonusPoints;
          echo $pointString="$batPoints#@#$ballPoints#@#$fieldPoints#@#$bonusPoints";
         echo "<br>TOTAL POINTS: $totalPoints".'<br/>';
    ...
    echo $playerTable='s'.$seriesId.'_player_data';
    echo '<br/>';
    //$updatestring="UPDATE $playerTable SET match$matchId='$pointString', batting_pts=batting_pts+$batPoints, bowling_pts=bowling_pts+$ballPoints, fielding_pts=fielding_pts+$fieldPoints, total_bonus=total_bonus+$bonusPoints WHERE id=$id ;";
    $updatestring="UPDATE $playerTable SET match$matchId='$pointString', batting_pts=batting_pts+$batPoints, bowling_pts=bowling_pts+$ballPoints, fielding_pts=fielding_pts+$fieldPoints,total_bonus=total_bonus+$bonusPoints, total_point=total_point+$totalPoints WHERE id=$id ;";
    echo $updatestring.'<br/>';
    
    $handle=  fopen("update match $matchId.txt", 'a+');
    fwrite($handle, $updatestring."\n");
