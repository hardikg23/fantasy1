...
if(isset ($_POST['seriesId']) && isset ($_POST['matchId']) && isset ($_POST['matchType']))
{
    if(!empty ($_POST['seriesId']) && !empty ($_POST['matchId']) && !empty ($_POST['matchType']))
    {
        ...
        if($ResultSet_players_of_match=mysql_query("SELECT id,Name,match$matchId,style
                                                 from $playerTable
            ...
            while($row=mysql_fetch_array($ResultSet_players_of_match)) {
                ...
                echo "<option value='$id'>$id     $playerStyle      $name &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $matchPoints</option>";
